...
const SearchTool = ({searchTool,onChange,onClick}) => {
    ...
    return (
        <SearchToolBlock>
            <Wrap>
                <Title>검색 툴 :</Title>
                <StyledSelectBox name="searchTool" onChange={onChange} value={searchTool.searchTool}>
            ...
            <Wrap>
                <Title>창 모드 :</Title>
                <StyledSelectBox name="openMode" onChange={onChange} value={searchTool.openMode}>
